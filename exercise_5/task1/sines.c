...
#include <time.h> 
#include <ctype.h>
// In this exercise you need to paralelize the function sine // void 
int get_time(struct timespec* t) {
	clock_gettime(CLOCK_MONOTONIC, t);
}
void get_clockres(struct timespec* t) {
	clock_getres(CLOCK_MONOTONIC, t);
}
void sine(double *a, int N); int main(int argc, char * argv[]) {
